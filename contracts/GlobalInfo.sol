...
abstract contract GlobalInfo {
    ...
    function _dailyUpdate() private {
        ...
        if (currentBlockDay > currentContractDay) {
            ...
            uint256 newMintableWitcher = s_currentMintableWitcher;
            ...
            for (uint256 i; i < dayDifference; i++) {
                ...
                newMintableWitcher =
                    (newMintableWitcher * DAILY_SUPPLY_MINTABLE_REDUCTION) /
                    PERCENT_BPS;
                newMintPowerBonus =
                ...
                if (newMintableWitcher < CAPPED_MIN_DAILY_WITCHER_MINTABLE) {
                    newMintableWitcher = CAPPED_MIN_DAILY_WITCHER_MINTABLE;
                }
    ...
    /** @notice Returns current mintable witcher
     * @return currentMintableWitcher current mintable witcher
     */
    function getCurrentMintableWitcher() public view returns (uint256) {
        return s_currentMintableWitcher;
    }
